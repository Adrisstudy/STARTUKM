<?php
// staykan untuk header kat sini
include('header.php');
include('db.php');
$id_kolej = 12; // Kolej Aminuddin Baki
...
if (!$kolej) {
    echo "<div style='color:red;text-align:center;margin:40px 0;'>Maklumat Kolej Aminuddin Baki belum dimasukkan oleh staf.<br>Sila hubungi pentadbir untuk kemaskini info.</div>";
    exit;
}
...
<head>
    ...
    <link rel="stylesheet" href="header.css"> <!-- Tambah pautan ke header.css -->
    <style>
        ...
        .slideshow-container { position: relative; width: 100%; max-width: 420px; height: 320px; margin: 0 auto 30px auto; border-radius: 18px; overflow: hidden; box-shadow: 0 4px 24px #0002; }
            ...
            <div class="slideshow-container">
                <?php if (!empty($gambar_list)): ?>
                    <?php foreach ($gambar_list as $gambar): ?>
                        <img src="img/<?php echo $gambar; ?>" class="slide-img" alt="<?php echo $kolej['nama_kolej']; ?>">
                    <?php endforeach; ?>
                <?php else: ?>
