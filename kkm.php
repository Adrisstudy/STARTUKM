...
if (!$kolej) {
    echo "<div style='color:red;text-align:center;margin:40px 0;'>Maklumat Kolej Keris Mas belum dimasukkan oleh staf.<br>Sila hubungi pentadbir untuk kemaskini info.</div>";
    exit;
}
